...
const useBudgetStore = create(
  ...
  setSupplementalAccounts: (accounts) =>
    get().dispatch({ type: actionTypes.SET_SUPPLEMENTAL_ACCOUNTS, payload: accounts }),
  setUnassignedCash: (amount) =>
    get().dispatch({ type: actionTypes.SET_UNASSIGNED_CASH, payload: amount }),
  setPaycheckHistory: (history) =>
    get().dispatch({ type: actionTypes.SET_PAYCHECK_HISTORY, payload: history }),
  setActualBalance: (balance) =>
    get().dispatch({ type: actionTypes.SET_ACTUAL_BALANCE, payload: balance }),
  setTransactions: (transactions) =>
    get().dispatch({ type: actionTypes.SET_TRANSACTIONS, payload: transactions }),
  setAllTransactions: (transactions) =>
    get().dispatch({ type: actionTypes.SET_ALL_TRANSACTIONS, payload: transactions }),
  setBiweeklyAllocation: (amount) =>
    get().dispatch({ type: actionTypes.SET_BIWEEKLY_ALLOCATION, payload: amount }),
  ...
  updateSavingsGoal: (goal) =>
    get().dispatch({ type: actionTypes.UPDATE_SAVINGS_GOAL, payload: goal }),
