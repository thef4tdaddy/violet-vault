  ...
  return (
    <div className="mt-4 pt-4 border-t-2 border-black">
      <h4 className="font-black text-black text-sm mb-3">
        <span className="text-base">I</span>TEMS <span className="text-base">F</span>OUND ({items.length})
      </h4>
      <div className="glassmorphism rounded-lg p-3 border border-white/20 bg-white/20 backdrop-blur-sm max-h-32 overflow-y-auto">
        <div className="space-y-1">
          {items.slice(0, 5).map((item, index) => (
            <div key={index} className="flex justify-between text-sm py-1 px-2 glassmorphism rounded border border-white/10 bg-white/10">
