    ...
    <div className="space-y-6" data-testid="account-balance-overview">
      <div className="px-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Actual Balance */}
          <div className="bg-blue-50 rounded-2xl p-6 hard-border shadow-sm">
          ...
          {/* Virtual Balance */}
          <div className="bg-green-50 rounded-2xl p-6 hard-border shadow-sm">
            <div className="flex items-center justify-between mb-4">
          ...
          {/* Difference */}
          <div className={`rounded-2xl p-6 hard-border shadow-sm ${diffStyles.bg}`}>
            <div className="flex items-center justify-between mb-4">
