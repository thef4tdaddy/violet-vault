      ...
      <div className="glassmorphism rounded-lg max-w-md w-full p-6 border-2 border-black bg-white/90 backdrop-blur-sm">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="font-black text-black text-xl mb-2">
            🚀 <span className="text-2xl">N</span>EW <span className="text-2xl">V</span>ERSION <span className="text-2xl">R</span>EADY!
          </h2>

          <p className="text-purple-900 text-sm leading-relaxed">
            We've updated VioletVault with new features and fixes.
