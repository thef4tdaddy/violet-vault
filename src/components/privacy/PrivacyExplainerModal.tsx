            ...
            <div className="glassmorphism rounded-2xl p-4 bg-blue-50/80 border-2 border-blue-400">
              ...
              <div className="bg-white/60 rounded-lg p-4 mb-3 border border-gray-300">
                <div className="flex items-center justify-center gap-3 text-sm font-semibold text-gray-900">
                  ...
                  <ArrowRightIcon className="h-4 w-4 text-blue-600" />
                  <span className="px-3 py-2 bg-green-100 rounded-lg border-2 border-black">
                    ⚡ Vercel
                  </span>
                  <ArrowRightIcon className="h-4 w-4 text-blue-600" />
                  <span className="px-3 py-2 bg-blue-100 rounded-lg border-2 border-black">
              ...
              <ul className="space-y-2 text-sm text-gray-700">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-blue-600 font-bold mt-0.5">✓</span>
                  <span>
                    <strong>Faster computation</strong> - Serverless functions for heavy
                    calculations
                  </span>
                </li>
                <li className="flex items-start gap-2">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700 mb-2">
                    <strong>Your data is yours.</strong> We never sell, share, or use your financial
                    data for any purpose other than providing the service you requested.
                  </p>
                  <p className="text-sm text-gray-700">
                    All tiers are designed with privacy-first principles. Choose the tier that best
                    matches your privacy needs and performance preferences.
                  </p>
                </div>
              </div>
            </div>
