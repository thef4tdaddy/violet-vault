 ...
 */
const PaycheckAllocationPreview: React.FC<PaycheckAllocationPreviewProps> = ({
  preview,
  hasAmount,
  envelopes = [],
}) => {
 ...
 */
const AllocationSummary: React.FC<{ preview: PreviewData }> = ({ preview }) => (
 ...
 */
const EnvelopeAllocations: React.FC<{ preview: PreviewData; envelopes: Envelope[] }> = ({
  preview,
  envelopes,
}) => (
  <div className="glassmorphism rounded-2xl p-6 border border-white/20">
 ...
 */
const UnassignedCashDisplay: React.FC<{ preview: PreviewData }> = ({ preview }) => (
