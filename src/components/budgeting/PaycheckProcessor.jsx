  ...
  return (
    <div className="rounded-lg p-6 border-2 border-black bg-purple-100/40 backdrop-blur-sm space-y-6">
          ...
          <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="px-6 py-4 bg-emerald-500 text-white rounded-2xl hover:bg-emerald-600 transition-colors border-2 border-black"
                    ...
                    {uniquePayers.length > 0 ? (
                      <button
                        ...
                        className="px-6 py-4 bg-gray-500 text-white rounded-2xl hover:bg-gray-600 transition-colors border-2 border-black"
            ...
            <div>
              ...
              <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-[auto_1fr] gap-4 items-start">
                    ...
                    <div>
                      <div className="flex items-center mb-2">
                        {React.createElement(getIcon("Wallet"), { className: "h-5 w-5 mr-3 text-purple-600" })}
                ...
                <div className="glassmorphism border-2 border-black rounded-2xl hover:border-emerald-300 transition-all p-6">
                  <div className="grid grid-cols-[auto_1fr] gap-4 items-start">
                    <input
                      type="radio"
                      value="leftover"
                    ...
                    <div>
                      <div className="flex items-center mb-2">
                        {React.createElement(getIcon("TrendingUp"), { className: "h-5 w-5 mr-3 text-emerald-600" })}
          ...
          <div className="glassmorphism rounded-2xl p-6 border-2 border-black">
            ...
            {!showPreview || !preview ? (
              <div className="text-center py-12 text-gray-500">
                {React.createElement(getIcon("Calculator"), { className: "h-16 w-16 mx-auto mb-4 opacity-30" })}
      ...
      {paycheckHistory.length > 0 && (
        <div className="glassmorphism rounded-3xl p-8">
          <h3 className="font-black text-black text-base flex items-center">
            {React.createElement(getIcon("Clock"), { className: "h-5 w-5 mr-2 text-cyan-600" })}
            <span className="text-lg">R</span>ECENT <span className="text-lg">P</span>AYCHECKS
          </h3>
          <div className="space-y-4 mt-6">
            {paycheckHistory.slice(0, 5).map((paycheck) => (
              <div
                key={paycheck.id}
                className="glassmorphism flex items-center justify-between p-6 rounded-2xl border-2 border-black hover:shadow-xl transition-all"
              >
                <div className="flex items-center space-x-4">
                  <div
                    className="w-12 h-12 rounded-2xl flex items-center justify-center text-white font-bold border-2 border-black"
                    style={{
                      background:
                ...
                <div className="flex items-center space-x-4">
                  ...
                  {onDeletePaycheck && (
                    <button
                      ...
                      className="p-2 text-red-500 hover:text-red-700 hover:bg-red-50 rounded-xl transition-colors disabled:opacity-50 border-2 border-black"
                    ...
                    >
                      {deletingPaycheckId === paycheck.id ? (
                        ...
                        React.createElement(getIcon("Trash2"), { className: "h-5 w-5" })
                      )}
                    </button>
                  )}
                </div>
          ...
          {paycheckHistory.length > 5 && (
            <div className="text-center mt-6">
              <button className="btn btn-secondary rounded-2xl border-2 border-black">
