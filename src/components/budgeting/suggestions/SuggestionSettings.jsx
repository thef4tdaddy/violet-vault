        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              onChange={(e) => handleSettingChange("overspendingThreshold", parseFloat(e.target.value) || 1)}
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              onChange={(e) => handleSettingChange("bufferPercentage", parseFloat(e.target.value) || 1)}
              className="block w-full pr-8 pl-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent text-sm"
              placeholder="1.1"
              min="1"
              max="2"
