      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-6">
        ...
        >
          <div className="text-center">
            <Plus className="h-12 w-12 mx-auto mb-4 opacity-80" />
            <h3 className="text-lg font-semibold mb-2">Add Envelope</h3>
            <p className="text-sm opacity-90">Create a new budget envelope</p>
          </div>
        </div>
