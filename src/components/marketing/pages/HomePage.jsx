      ...
      <section className="text-center py-20">
        <div className="rounded-lg p-8 border-2 border-black bg-purple-100/40 backdrop-blur-sm">
          <h1 className="font-black text-black text-6xl mb-6">
            <span className="text-7xl">T</span>AKE{" "}
            <span className="text-7xl">C</span>ONTROL{" "}
            <span className="text-7xl">O</span>F{" "}
            <span className="text-7xl">Y</span>OUR{" "}
            <span className="text-7xl">F</span>INANCES
          </h1>
          <p className="text-purple-900 text-xl mb-8 max-w-3xl mx-auto">
            Violet Vault is the secure, envelope-based budgeting app that helps
            you manage every dollar with precision. Built for individuals and
            families who want financial freedom through intentional spending.
          </p>
      ...
      <section className="text-center py-16">
        <div className="rounded-lg p-8 border-2 border-black bg-gradient-to-r from-purple-100/60 to-blue-100/60 backdrop-blur-sm">
          <h2 className="font-black text-black text-4xl mb-4">
            <span className="text-5xl">R</span>EADY{" "}
            <span className="text-5xl">T</span>O{" "}
