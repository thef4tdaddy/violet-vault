...
const StandardTabs = ({
  ...
  const colorConfig = {
    blue: {
      ...
      count: {
        pastel: "bg-blue-200 text-blue-800",
        bright: "bg-blue-400 text-blue-50",
      },
    },
    green: {
      ...
      count: {
        pastel: "bg-emerald-200 text-emerald-800",
        bright: "bg-emerald-400 text-emerald-50",
      },
    },
    red: {
      ...
      count: {
        pastel: "bg-red-200 text-red-800",
        bright: "bg-red-400 text-red-50",
      },
    },
    amber: {
      ...
      count: {
        pastel: "bg-amber-200 text-amber-800",
        bright: "bg-amber-400 text-amber-50",
      },
    },
    purple: {
      ...
      count: {
        pastel: "bg-purple-200 text-purple-800",
        bright: "bg-purple-400 text-purple-50",
      },
    },
    cyan: {
      ...
      count: {
        pastel: "bg-cyan-200 text-cyan-800",
        bright: "bg-cyan-400 text-cyan-50",
      },
    },
    gray: {
      ...
      count: {
        pastel: "bg-gray-200 text-gray-800",
        bright: "bg-gray-500 text-gray-50",
      },
    },
  };
      ...
      <nav className={navClass}>
        {tabs.map((tab) => {
          ...
          if (variant === "colored" && tab.color && !isDisabled) {
            ...
            countStyles = isActive ? colors.count.bright : colors.count.pastel;
          }
