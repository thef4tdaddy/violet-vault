...
describe('validationUtils', () => {
  describe('validateImportedData', () => {
    ...
    it('should throw an error for invalid JSON', () => {
      expect(() => validateImportedData(null, currentUser)).toThrow('Invalid backup file: not a valid JSON object.');
    });

    it('should throw an error for missing envelopes data', () => {
      const importedData = { bills: [] };
      expect(() => validateImportedData(importedData, currentUser)).toThrow('Invalid backup file: missing or invalid envelopes data.');
    });
    ...
    it('should return validated data for a valid import file', () => {
      ...
      const { validatedData, hasBudgetIdMismatch } = validateImportedData(importedData, currentUser);
