...
describe('useExportData', () => {
  it('should export data successfully', async () => {
    ...
    useToastHelpers.mockReturnValue({ showSuccessToast, showErrorToast: vi.fn(), showWarningToast: vi.fn() });
  ...
  it('should show a warning if there is no data to export', async () => {
    ...
    useToastHelpers.mockReturnValue({ showSuccessToast: vi.fn(), showErrorToast: vi.fn(), showWarningToast });
