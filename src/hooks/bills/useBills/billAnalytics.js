...
export const useBillAnalytics = (bills = []) => {
  return useMemo(() => {
    ...
    const paidAmount = bills
      ...
      .reduce((sum, bill) => sum + (parseFloat(bill.paidAmount) || parseFloat(bill.amount) || 0), 0);
    ...
    const upcomingAmount = upcomingBills.reduce((sum, bill) => sum + (parseFloat(bill.amount) || 0), 0);
