...
test.describe("Transaction Management Workflow", () => {
  test("Test 1: Create transaction in envelope and verify balance updates", async ({
    ...
    const initialBalanceText = await page
      ...
      .first()
      .textContent();
    await test.step("✓ Initial balance:", initialBalanceText, async () => {});
    ...
    await test.step("✓ Opened transaction create dialog", async () => {});
    ...
    await test.step('✓ Entered description: "Milk and bread at corner store"', async () => {});
    ...
    await test.step("✓ Entered amount: $45.75", async () => {});
    ...
    if (await dateInput.isVisible().catch(() => false)) {
      ...
      await test.step("✓ Set date to today", async () => {});
    }
    ...
    if (await categorySelect.isVisible().catch(() => false)) {
      ...
      await test.step("✓ Selected category", async () => {});
    }
    ...
    await test.step("✓ Submitted transaction", async () => {});
    ...
    await test.step("✓ Transaction appears in list", async () => {});
    ...
    await test.step("✓ Transaction amount visible in list: $45.75", async () => {});
    ...
    await test.step("✓ Balance decreased by $45.75:", updatedBalanceText, async () => {});
  });
  ...
  test("Test 2: Edit transaction and verify balance recalculated correctly", async ({
    ...
    await test.step("✓ Opened transaction for editing", async () => {});
    ...
    await test.step("✓ Transaction edit dialog visible", async () => {});
    ...
    await test.step("✓ Current amount:", currentValue, async () => {});

    // STEP 5: Edit amount (change from $30 to $50)
    await amountField.clear();
    await amountField.fill("50");
    await test.step("✓ Updated amount to $50", async () => {});
    ...
    await test.step("✓ Transaction amount updated in list: $50", async () => {});
    ...
    await test.step("✓ Transaction description updated", async () => {});
  });
  ...
  test("Test 3: Delete transaction and verify balance refunded", async ({
    ...
    await test.step("✓ Envelope with transaction created", async () => {});
    ...
    const balanceBefore = await page
      ...
      .first()
      .textContent();
    await test.step("✓ Balance before delete:", balanceBefore, async () => {});
    ...
    await test.step("✓ Clicked delete button", async () => {});
    ...
    if (await confirmButton.isVisible({ timeout: 2000 }).catch(() => false)) {
      ...
      await test.step("✓ Confirmed deletion", async () => {});
    }
    ...
    await test.step("✓ Transaction removed from list", async () => {});
    ...
    await test.step("✓ Balance increased by $25:", balanceAfter, async () => {});
  });
  ...
  test("Test 4: Search/filter transactions by description", async ({ authenticatedPage: page }) => {
    ...
    await test.step("✓ Envelope with 3 transactions created", async () => {});
    ...
    await test.step("✓ All 3 transactions visible", async () => {});
    ...
    if (await searchInput.isVisible({ timeout: 2000 }).catch(() => false)) {
      ...
      if (isBreadHidden) {
        await test.step("✓ Search filtered to show only milk-related transactions", async () => {});
      } else {
        await test.step("✓ Search returned results containing milk", async () => {});
      }
      ...
      await test.step("✓ Cleared search, all transactions visible again", async () => {});
    } else {
      await test.step("⚠ Search input not found - skipping search test", async () => {});
    }
  });
  ...
  test("Test 5: Filter transactions by date range", async ({ authenticatedPage: page }) => {
    ...
    await test.step("✓ Envelope with transactions on different dates created", async () => {});
    ...
    if (await startDateInput.isVisible({ timeout: 2000 }).catch(() => false)) {
      ...
      await test.step("✓ Today and yesterday transactions visible", async () => {});

      const oldItem = page.locator("text=Old purchase").first();
      const isOldHidden = !(await oldItem.isVisible().catch(() => false));
      if (isOldHidden) {
        await test.step("✓ Old transaction filtered out correctly", async () => {});
      }
    } else {
      await test.step("⚠ Date filter not found - skipping date filter test", async () => {});
    }
  });
});
