...
from .models import CONDITION_TYPES, AutoFundingContext, AutoFundingRule, Condition


def should_rule_execute(rule: AutoFundingRule, context: AutoFundingContext) -> bool:
    """
...
def evaluate_conditions(conditions: list[Condition], context: AutoFundingContext) -> bool:
    """
...
def evaluate_date_range_condition(condition: Condition, current_date: str) -> bool:
    """
...
def evaluate_transaction_amount_condition(
    condition: Condition, context: AutoFundingContext
) -> bool:
    """
...
def check_schedule(trigger: str, last_executed: str | None, current_date: str) -> bool:
    """
...
def check_payday_schedule(last_executed: datetime, now: datetime) -> bool:
    """
