...
- Savings Goals → Envelopes with `envelopeType: "savings"`
- Supplemental Accounts → Envelopes with `envelopeType: "supplemental"`
...
1. **Savings Goals** → Converted to envelopes with `envelopeType: "savings"`
2. **Supplemental Accounts** → Converted to envelopes with `envelopeType: "supplemental"`
3. **All relationships** → Preserved and updated
4. **Balances** → Recalculated and verified
