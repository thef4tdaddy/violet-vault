...
| TypeScript Strict Mode Errors | 268 | +268 |

*Last updated: 2025-11-25 22:22:19 UTC*
...
- 1 issues in `/home/runner/work/violet-vault/violet-vault/src/hooks/common/useActualBalance.ts`
...
/home/runner/work/violet-vault/violet-vault/src/hooks/common/useActualBalance.ts:37:9 - 1 - The 'setStoreBalance' function makes the dependencies of useCallback Hook (at line 91) change on every render. Move it inside the useCallback callback. Alternatively, wrap the definition of 'setStoreBalance' in its own useCallback() Hook. (react-hooks/exhaustive-deps)
```
...
src/utils/debts/debtCalculations.ts(84,52): error TS2345: Argument of type 'DebtAccount' is not assignable to parameter of type 'Debt'.
  Types of property 'nextPaymentDate' are incompatible.
    Type 'string | Date' is not assignable to type 'string'.
      Type 'Date' is not assignable to type 'string'.
src/utils/debts/debtCalculations.ts(87,48): error TS2345: Argument of type 'DebtAccount' is not assignable to parameter of type 'DebtInput'.
  Property 'currentBalance' is optional in type 'DebtAccount' but required in type 'DebtInput'.
```
...
- 3 errors in `src/utils/debts/debtCalculations.ts`
- 3 errors in `src/components/transactions/splitter/SplitAllocationsSection.tsx`
- 3 errors in `src/components/transactions/TransactionTable.tsx`
