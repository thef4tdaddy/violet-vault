...
src/components/debt/DebtStrategies.tsx(108,27): error TS2322: Type 'PaymentImpactScenario[]' is not assignable to type 'never[]'.
  Type 'PaymentImpactScenario' is not assignable to type 'never'.
...
src/components/savings/SavingsGoals.tsx(140,9): error TS2322: Type '(goalData: any, goalId?: null) => Promise<void>' is not assignable to type '(goalData: GoalData, goalId?: string | undefined) => void'.
