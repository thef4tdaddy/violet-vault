...
const useLargeComponentLogic = () => { /* 50 lines */ };
const LargeComponentHeader = () => { /* 20 lines */ };
const LargeComponentBody = () => { /* 30 lines */ };
const LargeComponent = () => { /* 25 lines */ };
```
...
const extractedFunction = (a, b, c, d, e, f) => { // Now 6 parameters!
  if (a && b && c && d && e && f) { // Still complex!
    // logic
  }
};
```
